    ...
    <div>
      ...
      <GuideList>
        <li>
          <p>1. 캠페인 신청하기</p>
          <p>
            ⏳ 캠페인 신청 후 <Red>"3시간 이내"</Red>{" "}
            <b>구매 및 영수증 인증을 완료</b>해주세요.
          </p>
        </li>
        <li>
          <p>2. 캠페인 상품 구매</p>
          <p>
            - [나의 캠페인] &gt; '상품 구매' 클릭 &gt; '구매하러 가기' 클릭
            <br />
            <b>
        ...
        <li>
          ...
          <p>
            - [네이버 앱/웹] 접속 &gt; 'pay' 아이콘 클릭 &gt; 하단 '결제' 아이콘
            클릭 &gt; 결제한 상품의 '주문상세' 혹은 '결제상세' 클릭
          </p>
        </li>
        <li>
          <p>4. 구매영수증 캡쳐</p>
          <p>- '영수증' 클릭 &gt; '구매영수증' 클릭 &gt; 구매영수증 캡쳐</p>
        </li>
        <li>
          <p>5. 구매영수증 업로드</p>
          <p>- [나의 캠페인] &gt; '상품구매' 클릭 &gt; '이미지 업로드' 클릭</p>
        </li>
      </GuideList>
      <Divider />
      ...
      <GuideList>
        ...
        <li>
          ...
          <p>
            - [나의 캠페인] &gt; '리뷰등록' 클릭 &gt; '리뷰 등록하러가기' 클릭
            &gt; 상품페이지 내 리뷰영역에 검수완료된 내용 붙여넣기
            <br />
            <b>
              ★ <Red>ID, 날짜, 상품명, 리뷰 전체 내용</Red>이 보이도록 이미지
              캡쳐
            </b>
          </p>
        </li>
        <li>
          <p>4. 실제 리뷰 이미지 업로드</p>
          <p>
            - [나의 캠페인] &gt; '리뷰등록' 클릭 &gt; '이미지 업로드' 클릭
            <br />
            <b>
              ★ 적립된 포인트는 '마이페이지' &gt; '포인트 적립내역'에서 확인할
              수 있습니다.
            </b>
          </p>
        </li>
