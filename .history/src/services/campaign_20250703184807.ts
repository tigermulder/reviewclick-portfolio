...
// B2 API 설정
const B2_API_BASE_URL = "https://dev-api.revuclick.io"
const B2_API_KEY = "NmSmTuUa2HRFQDiDEfvvWCaZT5Oj7V9H"
const B2_SPACE_CODE = "Ska1a8fo"
...
export const getCampaignList = async (
  ...
  try {
    ...
    const response = await axios.get(
      `${B2_API_BASE_URL}/b2/ads/${B2_SPACE_CODE}`,
      {
        params: {
          apikey: B2_API_KEY,
...
export const getCampaignItem = async (
  ...
  try {
    // 먼저 B2 API Check로 시도
    const response = await axios.get(
      `${B2_API_BASE_URL}/b2/ads/${B2_SPACE_CODE}/${data.campaignCode}/check`,
      {
        params: {
          apikey: B2_API_KEY,
